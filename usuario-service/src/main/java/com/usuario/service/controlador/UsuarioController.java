...
public class UsuarioController {
	...
	private ResponseEntity<Carro> fallBackSaveCarro(@PathVariable("usuarioId") int usuarioId,@RequestBody Carro carro){
		return new ResponseEntity("El usuario:"+usuarioId+" no tiele lana, para carros",HttpStatus.OK);
	}
	...
	private ResponseEntity<Moto> fallBackSaveMoto(@PathVariable("usuarioId") int usuarioId,@RequestBody Moto moto){
		return new ResponseEntity("El usuario:"+usuarioId+" no tiele lana, para motos",HttpStatus.OK);
	}
	
	private ResponseEntity<Map<String, Object>> fallBackGetTodos(@PathVariable("usuarioId") int usuarioId){
		return new ResponseEntity("El usuario:"+usuarioId+" no se muestra nada en todos",HttpStatus.OK);
	}
}